...
// http://i18next.com
/* Meble app - fixing bug of multiple init overwriting resStore */
...
(function() {
    ...
    function init(options, cb) {
        ...
        i18n.sync.load(lngsToLoad, o, function(err, store) {
            resStore = deepExtend(resStore,store); /* Meble app - fixing bug of multiple init overwriting resStore */
            initialized = true;
            if (cb) cb(lngTranslate);
            if (deferred) deferred.resolve(lngTranslate);
        });
